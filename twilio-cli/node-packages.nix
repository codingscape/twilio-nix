...
let
  sources = {
    ...
    "@sendgrid/client-7.4.3" = {
      ...
      version = "7.4.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@sendgrid/client/-/client-7.4.3.tgz";
    ...
    "@sendgrid/helpers-7.4.3" = {
      ...
      version = "7.4.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@sendgrid/helpers/-/helpers-7.4.3.tgz";
        sha512 = "Wt+68g1sVEM5UspJh34O/cxtv6BBbtAIk7U9B3PB2ySOtPs9e6hI1QkgYVwpNmkt7k2p86muUNyma/Aig25agg==";
      };
    };
    "@sendgrid/mail-7.4.4" = {
      ...
      version = "7.4.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@sendgrid/mail/-/mail-7.4.4.tgz";
        sha512 = "9+dyArajxbPY7eJJAd2eps7MVsXW9E4Y294gWeMYku0/Id/qAivexidjstvkkVlZdlrHbEsGDlnMEcw2eXOiFg==";
      };
    };
    ...
    "@twilio/cli-core-5.24.0" = {
      name = "_at_twilio_slash_cli-core";
      packageName = "@twilio/cli-core";
      version = "5.24.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@twilio/cli-core/-/cli-core-5.24.0.tgz";
        sha512 = "8JR6pJZi3/9xoeUcpOVVS11ixVYbvq3C60vbCkgSIstm+8tV/Vmt8t9TIeJ06Ko2OkwoEDtq3mLhpUwXjt5aGA==";
      };
    };
    ...
    "twilio-3.63.1" = {
      ...
      version = "3.63.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/twilio/-/twilio-3.63.1.tgz";
        sha512 = "xwtOM78sO2jGxKg1AW+7XlJdrhTMW9dzr6665O+IB/VtNVQB7JQS48pLCZFnBaTvZOILVO0Q6t63wv24hIbr/A==";
      };
    };
    "type-fest-0.21.3" = {
      name = "type-fest";
...
in
{
  twilio-cli = nodeEnv.buildNodePackage {
    ...
    version = "2.24.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/twilio-cli/-/twilio-cli-2.24.0.tgz";
      sha512 = "cnlBnttMr9XX4+q1245oETxD2l7BCXiSBJOB1UzfJnkfo96A76kB7aseFoWXq9FIu0OPr8pb22se62XjCnpHwQ==";
    };
    dependencies = [
      ...
      sources."@sendgrid/client-7.4.3"
      sources."@sendgrid/helpers-7.4.3"
      sources."@sendgrid/mail-7.4.4"
      sources."@tokenizer/token-0.1.1"
      (sources."@twilio/cli-core-5.24.0" // {
        dependencies = [
          sources."fs-extra-9.1.0"
          sources."jsonfile-6.1.0"
          sources."universalify-2.0.0"
